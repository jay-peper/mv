...
sql 'select Mitgliedsnummer,Vorname,Nachname,eintritts_datum from ungesperrte where "ma angefordert" like "" AND Beitrag like "2012" AND Mitgliedsnummer not like ""' \
